...
Bars.prototype.renderFileSync = function(file, locals) {
  ...
  // save old
  var $__dirname = locals.__dirname;
  var $__filename = locals.__filename;
  ...
  var ret = this.render(tmpl, locals);

  // recover
  locals.__dirname = $__dirname;
  locals.__filename = $__filename;
...
Bars.prototype.registerHelper = function() {
  ...
  handlebars.registerHelper('extend', function(name, options) {
    ...
    // do template
    return bars.renderFileSync(layoutFile, ctx);
  });
